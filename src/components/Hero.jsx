    ...
    <div className='relative min-h-screen '>
        ...
        <div className='absolute inset-0 flex items-center px-4 md:px-8 lg:px-16'>
            <div className='max-w-4xl'>
                <h1 className='text-3xl md:text-5xl lg:text-[55px] font-sans text-white mb-6 leading-tight'><span className='font-semibold'>Reliable Cargo & Logistics Services</span>  On Time, Every Time</h1>
