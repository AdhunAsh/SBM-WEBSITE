  ...
  return (
    <footer className="bg-[#2B3167] text-white py-16 px-4">
      <div className="max-w-7xl mx-auto">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12 lg:gap-30">
          {/* Company Info */}
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="https://x.com/LlcSbm64739?t=YN3xWMpo_Hcwhh-D4cViWg&s=09" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#F9B500] rounded-full flex items-center justify-center hover:bg-[#e6a300] transition-colors duration-300">
                <svg className="w-5 h-5 text-[#2B3167]" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="https://www.linkedin.com/in/sbm-cargo-sbm-cargo-services-llc-040bb0386?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#F9B500] rounded-full flex items-center justify-center hover:bg-[#e6a300] transition-colors duration-300">
                <svg className="w-5 h-5 text-[#2B3167]" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/sbm.cargo.services.llc/?__pwa=1" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#F9B500] rounded-full flex items-center justify-center hover:bg-[#e6a300] transition-colors duration-300">
                <svg className="w-5 h-5 text-[#2B3167]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-300">
              <div className="flex items-center">
                ...
                <a href='tel:+971565819403'><span className="text-sm">+971 56 581 9403</span></a>
              ...
              <div className="flex items-center">
                ...
                <a href='tel:+97148248553'><span className="text-sm">+971 4 824 8553</span></a>
              </div>
        ...
        <div className="border-t border-gray-600 pt-8">
          <div className="flex flex-col md:flex-row justify-center items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2025 SBM Logistics. All rights reserved.
            </p>
