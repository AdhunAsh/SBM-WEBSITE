        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.instagram.com/p/DN44Z9nkhOF/?igsh=NWlsemdybzBxN3ly" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#F9B500] rounded-full flex items-center justify-center hover:bg-[#e6a300] transition-colors duration-300">
                <svg className="w-5 h-5 text-[#2B3167]" fill="currentColor" viewBox="0 0 24 24">
